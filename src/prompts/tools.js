...
const toolRoutes = [
  ...
  // ═══════════════════════════════════════════════════════════════════
  // SECTION: FRONTEND ALIASES & NEW TOOLS
  // (Added so every tool slug used by the website actually resolves —
  // previously 47 tools on the live site had no matching backend route
  // and returned 404 "Endpoint not found".)
  // ═══════════════════════════════════════════════════════════════════
  { path: 'ai-blog-writer', prompt: (t) => `Write a 1500+ word SEO blog about "${t}". H1 with keyword. First 155 chars as meta description. 5-6 H2 sections. Short paragraphs. Bullet lists. Include: <a href="${WEBSITE_URL}/tools" style="color:#2563eb;font-weight:600;">free AI tools</a>. Conclusion with CTA. OUTPUT ONLY HTML.` },
  { path: 'ai-image-generator', type: 'image' },
  { path: 'ai-logo-maker', type: 'logo' },
  { path: 'ai-press-release', prompt: (t) => `Write a professional press release for: "${t}". Include: FOR IMMEDIATE RELEASE, headline, dateline, introduction paragraph (who, what, when, where, why), 2 body paragraphs with quotes, boilerplate, and contact info. Follow AP style. OUTPUT CLEAN TEXT.` },
  { path: 'ai-newsletter-writer', prompt: (t) => `Write an engaging email newsletter about: "${t}". Include a strong subject line, a short intro hook, 3 content sections with sub-headers, one CTA, and a friendly sign-off. OUTPUT JSON: {"subject":"...","preview_text":"...","sections":[{"heading":"...","body":"..."}],"cta":"..."}` },
  { path: 'ai-twitter-thread', prompt: (t) => `Write a 10-tweet viral Twitter/X thread about: "${t}". Tweet 1 must be a scroll-stopping hook. Each subsequent tweet builds value. Final tweet has a CTA. Each tweet under 280 characters. OUTPUT JSON: {"tweets":["..."]}` },
  { path: 'ai-sales-email-sequence', prompt: (t) => `Write a complete 7-email sales nurture sequence for: "${t}". Cover: welcome, value/education, social proof, objection handling, urgency, last chance, and a final close email. Each with subject line and body. OUTPUT JSON: {"emails":[{"day":1,"subject":"...","body":"..."}]}` },
  { path: 'ai-cold-dm', prompt: (t) => `Write 5 high-converting cold outreach DMs for: "${t}". Include one each for LinkedIn, Instagram, Twitter/X, and 2 follow-ups. Keep each under 60 words, casual, no hard sell. OUTPUT JSON: {"dms":[{"platform":"...","message":"..."}]}` },
  { path: 'ai-tagline-generator', prompt: (t) => `Generate 10 memorable taglines for: "${t}". Short, catchy, brandable. OUTPUT JSON: {"taglines":["..."]}` },
  { path: 'ai-youtube-script', prompt: (t) => `Write a complete YouTube video script for: "${t}". Include: a 3-second hook, intro, 3-5 main content segments with on-screen direction notes, a mid-roll subscribe reminder, and a strong outro with CTA. OUTPUT JSON: {"hook":"...","intro":"...","segments":[{"title":"...","script":"..."}],"outro":"..."}` },
  { path: 'ai-podcast-script', prompt: (t) => `Write a full podcast episode script for: "${t}". Include: cold open, intro music cue notes, 3 main talking segments with bullet talking points, listener Q&A segment, and outro with CTA to subscribe/review. OUTPUT JSON: {"cold_open":"...","intro":"...","segments":[{"title":"...","talking_points":["..."]}],"outro":"..."}` },
  { path: 'youtube-seo-generator', prompt: (t) => `Generate YouTube SEO for a video about: "${t}". Provide 5 viral title options and 15 SEO-optimized tags, plus an optimized description. OUTPUT JSON: {"titles":["..."],"tags":["..."],"description":"..."}` },
  { path: 'ai-keyword-clusters', prompt: (t) => `Create SEO keyword clusters for: "${t}". Group keywords into 5 topic clusters, each with 1 pillar keyword and 5-8 supporting keywords with estimated intent. OUTPUT JSON: {"clusters":[{"pillar":"...","supporting":["..."],"intent":"..."}]}` },
  { path: 'ai-google-ads', prompt: (t) => `Create 5 complete Google Responsive Search Ad (RSA) campaigns for: "${t}". Each with 8 headlines (max 30 chars), 4 descriptions (max 90 chars), and 4 sitelink extensions. OUTPUT JSON: {"campaigns":[{"headlines":["..."],"descriptions":["..."],"sitelinks":["..."]}]}` },
  { path: 'ai-email-subject-lines', prompt: (t) => `Generate 20 high-converting email subject lines for: "${t}". For each, give a predicted open-rate tier (High/Medium/Low) and the persuasion angle used. OUTPUT JSON: {"subject_lines":[{"text":"...","predicted_open_rate":"High","angle":"..."}]}` },
  { path: 'ai-tiktok-caption', prompt: (t) => `Generate 10 viral TikTok captions for: "${t}". Each with a hook-style caption and 5 relevant trending hashtags. OUTPUT JSON: {"captions":[{"text":"...","hashtags":["..."]}]}` },
  { path: 'ai-pinterest-description', prompt: (t) => `Write 5 SEO-optimized Pinterest pin descriptions for: "${t}". Each under 500 characters, keyword-rich, with a soft CTA. OUTPUT JSON: {"descriptions":["..."]}` },
  { path: 'ai-ab-test-ideas', prompt: (t) => `Generate 10 high-impact A/B test ideas for: "${t}". Each with a clear hypothesis, what to change, and the expected metric impact. OUTPUT JSON: {"tests":[{"hypothesis":"...","change":"...","expected_impact":"..."}]}` },
  { path: 'ai-brand-voice', prompt: (t) => `Create a complete brand voice and tone guide for: "${t}". Include: voice personality traits, tone in 3 different contexts (support, marketing, social), words to use, words to avoid, and 3 example sentences. OUTPUT JSON: {"personality":["..."],"tone_examples":[{"context":"...","example":"..."}],"words_to_use":["..."],"words_to_avoid":["..."]}` },
  { path: 'ai-business-plan', prompt: (t) => `Write a full business plan for: "${t}". Include: executive summary, problem/solution, market analysis, business model, marketing strategy, financial projections (3-year summary), and team/operations. OUTPUT CLEAN TEXT.` },
  { path: 'ai-swot-analysis', prompt: (t) => `Create a complete SWOT analysis for: "${t}". Give at least 4 points each for Strengths, Weaknesses, Opportunities, Threats, plus 3 strategic recommendations based on the analysis. OUTPUT JSON: {"strengths":["..."],"weaknesses":["..."],"opportunities":["..."],"threats":["..."],"recommendations":["..."]}` },
  { path: 'ai-job-description', prompt: (t) => `Write an attractive, modern job description for: "${t}". Include: role summary, responsibilities, requirements, nice-to-haves, and benefits. OUTPUT JSON: {"title":"...","summary":"...","responsibilities":["..."],"requirements":["..."],"nice_to_have":["..."],"benefits":["..."]}` },
  { path: 'ai-nda-generator', prompt: (t) => `Draft a professional mutual Non-Disclosure Agreement for: "${t}". Include standard legal clauses: definitions, obligations, exclusions, term, remedies, governing law. Add a disclaimer that this is a template, not legal advice. OUTPUT CLEAN TEXT.` },
  { path: 'ai-refund-policy', prompt: (t) => `Write a clear, consumer-friendly refund and returns policy for: "${t}". Include: eligibility window, condition requirements, how to request a refund, processing time, and exceptions. OUTPUT CLEAN TEXT.` },
  { path: 'ai-cookie-policy', prompt: (t) => `Write a GDPR-compliant cookie policy for: "${t}". Include: what cookies are, types used (essential, analytics, marketing), third-party cookies, how to manage/disable cookies, and contact info. OUTPUT CLEAN TEXT.` },
  { path: 'ai-pitch-deck-outline', prompt: (t) => `Create a 12-slide investor pitch deck outline for: "${t}". For each slide give the slide title and 2-3 key talking points. Cover: problem, solution, market size, product, business model, traction, competition, team, financials, ask. OUTPUT JSON: {"slides":[{"title":"...","talking_points":["..."]}]}` },
  { path: 'ai-cover-letter', prompt: (t) => `Write a personalized, compelling cover letter for: "${t}". Professional tone, 3-4 paragraphs, highlight relevant strengths, strong closing call to action. OUTPUT CLEAN TEXT.` },
  { path: 'ai-linkedin-summary', prompt: (t) => `Write 3 LinkedIn "About" section variations for: "${t}". One story-driven, one results/metrics-driven, one thought-leadership style. Each 3-4 short paragraphs. OUTPUT JSON: {"versions":[{"style":"story","text":"..."},{"style":"results","text":"..."},{"style":"thought_leader","text":"..."}]}` },
  { path: 'ai-youtube-about', prompt: (t) => `Write a YouTube channel "About" section for: "${t}". Include a keyword-rich description, upload schedule line, and a CTA to subscribe. Keep under 1000 characters. OUTPUT CLEAN TEXT.` },
  { path: 'ai-personal-bio', prompt: (t) => `Write 5 versions of a personal bio for: "${t}" at these lengths: 25 words, 50 words, 100 words, 150 words, and 300 words. OUTPUT JSON: {"bios":[{"length":25,"text":"..."},{"length":50,"text":"..."},{"length":100,"text":"..."},{"length":150,"text":"..."},{"length":300,"text":"..."}]}` },
  { path: 'ai-meeting-agenda', prompt: (t) => `Create a professional meeting agenda for: "${t}". Include: meeting goal, 4-6 agenda items each with a time allocation, and a notes/action-items section at the end. OUTPUT JSON: {"goal":"...","items":[{"topic":"...","minutes":10}],"notes_section":true}` },
  { path: 'ai-smart-goals', prompt: (t) => `Convert this goal into 5 SMART goals (Specific, Measurable, Achievable, Relevant, Time-bound) for: "${t}". Each with a short action plan. OUTPUT JSON: {"goals":[{"smart_goal":"...","action_plan":["..."]}]}` },
  { path: 'ai-pros-cons', prompt: (t) => `Analyze the pros and cons of: "${t}". Give 8 pros and 8 cons, each with an impact level (High/Medium/Low), and end with an overall recommendation. OUTPUT JSON: {"pros":[{"point":"...","impact":"High"}],"cons":[{"point":"...","impact":"Medium"}],"recommendation":"..."}` },
  { path: 'ai-brainstorm', prompt: (t) => `Brainstorm 25 ideas for: "${t}" using 5 different brainstorming frameworks (5 ideas each): SCAMPER, First Principles, Reverse Brainstorming, Mind Mapping, and Random Word Association. OUTPUT JSON: {"frameworks":[{"name":"SCAMPER","ideas":["..."]}]}` },
  { path: 'ai-faq-generator', prompt: (t) => `Generate 15 frequently asked questions with answers for: "${t}". Also output ready-to-use JSON-LD FAQ schema markup. OUTPUT JSON: {"faqs":[{"question":"...","answer":"..."}],"json_ld_schema":"..."}` },
  { path: 'ai-survey-questions', prompt: (t) => `Create a 15-question customer/user survey for: "${t}". Mix question types: multiple choice, rating scale (1-5), and open-ended. OUTPUT JSON: {"questions":[{"type":"multiple_choice","question":"...","options":["..."]}]}` },
  { path: 'ai-project-plan', prompt: (t) => `Create a full project plan for: "${t}". Include: objective, 5-8 milestones with estimated timelines, key deliverables, resource needs, and a risk register with mitigation steps. OUTPUT JSON: {"objective":"...","milestones":[{"name":"...","timeline":"..."}],"risks":[{"risk":"...","mitigation":"..."}]}` },
  { path: 'ai-sop-writer', prompt: (t) => `Write a Standard Operating Procedure (SOP) document for: "${t}". Include: purpose, scope, step-by-step procedure (numbered), responsible roles, and quality checks. OUTPUT JSON: {"purpose":"...","scope":"...","steps":["..."],"quality_checks":["..."]}` },
  { path: 'ai-amazon-listing', prompt: (t) => `Write a complete Amazon product listing for: "${t}". Include: SEO title (under 200 chars), 5 bullet points, a description, and a list of backend search keywords. OUTPUT JSON: {"title":"...","bullets":["..."],"description":"...","backend_keywords":["..."]}` },
  { path: 'ai-etsy-description', prompt: (t) => `Write a story-driven Etsy shop/product description for: "${t}". Warm, handmade-feeling tone. Include all 13 Etsy-style tags. OUTPUT JSON: {"description":"...","tags":["..."]}` },
  { path: 'ai-product-title-optimizer', prompt: (t) => `Optimize a product title for: "${t}" across 4 marketplaces. Give one optimized title each for Amazon, Shopify, Etsy, and eBay, following each platform's best practices. OUTPUT JSON: {"amazon":"...","shopify":"...","etsy":"...","ebay":"..."}` },
  { path: 'ai-dropshipping-ideas', prompt: (t) => `Suggest 10 profitable dropshipping product ideas related to: "${t}". For each, give estimated profit margin, a marketing angle, and target audience. OUTPUT JSON: {"products":[{"name":"...","margin":"...","angle":"...","audience":"..."}]}` },
  { path: 'ai-promo-copy', prompt: (t) => `Write promotional sale copy for: "${t}" across 4 channels: email, social post, SMS, and push notification. Keep each on-brand and urgent. OUTPUT JSON: {"email":"...","social":"...","sms":"...","push":"..."}` },
  { path: 'ai-investor-email', prompt: (t) => `Write 3 investor outreach email variations for: "${t}". One for angel investors, one for VCs, one for strategic/corporate investors. Each concise, compelling, with a clear ask. OUTPUT JSON: {"angel":"...","vc":"...","strategic":"..."}` },
  { path: 'ai-grant-proposal', prompt: (t) => `Write a complete grant proposal for: "${t}". Include: organization summary, statement of need, project description, goals/objectives, budget summary, and evaluation plan. OUTPUT CLEAN TEXT.` },
  { path: 'ai-financial-summary', prompt: (t) => `Write a CFO-level financial report summary for: "${t}". Include: key KPIs, revenue/expense trends, notable risks, and 3 recommended actions. OUTPUT JSON: {"kpis":[{"metric":"...","value":"...","trend":"..."}],"risks":["..."],"recommendations":["..."]}` },
  { path: 'ai-budget-planner', prompt: (t) => `Create a detailed budget plan for: "${t}". Include: income sources, fixed expenses, variable expenses, savings target, and a 3-month projection. OUTPUT JSON: {"income":[{"source":"...","amount":"..."}],"expenses":[{"category":"...","amount":"..."}],"savings_target":"...","projection_3mo":"..."}` },
];
